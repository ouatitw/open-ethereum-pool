...
import (
	...
	"github.com/ouatitw/open-ethereum-pool/rpc"
	"github.com/ouatitw/open-ethereum-pool/storage"
)
...
func TestMatchCandidate(t *testing.T) {
	gvnsBlock := &rpc.GetBlockReply{Hash: "0x12345A", Nonce: "0x1A"}
