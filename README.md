...
[![Join the chat at https://gitter.im/ouatitw/open-ethereum-pool](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/ouatitw/open-ethereum-pool?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Build Status](https://travis-ci.org/ouatitw/open-ethereum-pool.svg?branch=develop)](https://travis-ci.org/ouatitw/open-ethereum-pool) [![Go Report Card](https://goreportcard.com/badge/github.com/ouatitw/open-ethereum-pool)](https://goreportcard.com/report/github.com/ouatitw/open-ethereum-pool)
...
* Failover gvns instances: gvns high availability built in
...
Clone & compile:
    ...
    git clone https://github.com/ouatitw/open-ethereum-pool.git
...
```javascript
{
  ...
  "proxy": {
    ...
    */
    ...
    // Try to get new job from gvns in this interval
  ...
  // Check health of each gvns node in this interval
  "upstreamCheckInterval": "5s",

  /* List of gvns nodes to poll for new jobs. Pool will try to get work from
  ...
  */
  ...
  "unlocker": {
    ...
    // Rise error if can't reach gvns in this amount of time
    "timeout": "10s"
  },
  ...
  "payouts": {
    ...
    "address": "0x0",
    // Let gvns to determine gas and gasPrice
    "autoGas": true,
...
This pool is tested to work with [Ethcore's Parity](https://github.com/ethcore/parity). Mining and block unlocking works, but I am not sure about payouts and suggest to run *official* gvns node for payments.
